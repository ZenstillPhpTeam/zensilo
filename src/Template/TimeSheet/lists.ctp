    ...
    <div class="panel-body content-box">
      ...
      <div class="example-box-wrapper">
        ...
        <div class="panel-body">
          <h3 class="title-hero">Time Sheet List </h3>
        ...
        <tbody>
          <?php foreach($requests as $k=>$request_det){ ?>
            ...
            <tr class="gradeA <?php if($k%2 == 0) {?>odd <?php } else { ?> even <?php } ?>" role="row">
              ...
              <td class="center"> 
                <?php if($request_det->status == 1){ ?> <div class="bs-label bg-yellow"> Pending</div> <?php }
                  elseif($request_det->status == 2){ ?> <div class="bs-label bg-green"> Approved</div> <?php }
                  elseif($request_det->status == 3){ ?> <div class="bs-label bg-red"> Rejected </div> <?php } ?>
              </td>
              <td class="center">
               
                <a href="<?= $this->Url->build(array("action" => "view", $request_det->id));?>"><i class="glyph-icon demo-icon tooltip-button icon-elusive-eye" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"></i></a>
