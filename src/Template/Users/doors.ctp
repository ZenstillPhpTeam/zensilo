    ...
    <div class="example-box-wrapper">
      <div class="hide-columns">
        <table class="table table-bordered table-striped table-condensed">
          ...
          <tbody>
            <?php foreach($doors as $k=>$dor){?>
            <tr>
              <td><?= $k+1?></td>
              <td><?= $dor->title;?></td>
              <td><?= $this->Custom->category_name($dor->category);?></td>
              <td><?= $this->Custom->color_name($dor->color);?></td>
              <td> <img width="90" src="<?php echo $siteurl.'upload/door/'.$dor->image; ?>"></td>
              <td>
                <a href="<?= $this->Url->build(array("action" => "doors", $dor->id));?>"><i class="glyph-icon icon-pencil"></i></a>&nbsp;&nbsp;
                <a href="<?= $this->Url->build(array("action" => "doors", $dor->id, "delete"));?>" onclick="javascript:confirm('Are you sure want to delete this door?')"><i class="glyph-icon icon-trash"></i></a>
              </td>
            </tr>
            <?php }?>
          </tbody>
    ...
    <div class="modal-content">
      <form method="post" enctype="multipart/form-data" class="form-horizontal bordered-row">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Doors</h4>
        </div>
        <div class="modal-body">
          <div class="content-box-wrapper">
               <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input value="<?= $door->title?>" name="title" class="form-control" id="" placeholder="Example placeholder..." type="text">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Description</label>
                  <div class="col-sm-6">
                    <textarea name="description" id="" class="form-control"><?= $door->description?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" name="category">
                      ...
                      <option <?= $door->category == $value['id'] ? 'selected' : '';?> value="<?php echo $value['id']; ?>"><?php echo $value['name']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" name="color">
                      ...
                      <option <?= $door->color == $value['id'] ? 'selected' : '';?> value="<?php echo $value['id']; ?>"><?php echo $value['name']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                   ...
                   <div class="col-sm-3">
                    <img width="90" src="<?php echo $siteurl.'upload/door/'.$door->image; ?>">
                  </div>
                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form method="post" enctype="multipart/form-data" class="form-horizontal bordered-row">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h4 class="modal-title">New Door</h4>
        </div>
        <div class="modal-body">
          <div class="content-box-wrapper">
                <div class="form-group">
