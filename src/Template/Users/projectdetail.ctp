...
<div id="page-title" style="padding: 25px 35px;"><h2><?= $project->project_name ?>&nbsp;&nbsp; <span class="bs-label label-success"><?= $project->status ?></span></h2><p><br/><?= $project->description ?></p></div>
       ...
       <div class="row">
        ...
        <div class="col-md-4"><a href="#" title="Example box" class="tile-box btn btn-default"><div class="tile-header">Estimated Start Date<div class="float-right"><i class="glyph-icon icon-caret-up"></i> +5%</div></div><div class="tile-content-wrapper"><i class="glyph-icon icon-tachometer"></i><div class="tile-content"><?= $project->estimated_start_date ?></div><small><i class="glyph-icon icon-caret-up"></i> +7,6% new users in the first quarter</small></div><div class="ripple-wrapper"></div></a></div>

        <div class="col-md-4"><a href="#" title="Example box" class="tile-box btn btn-default"><div class="tile-header">Estimated End Date<div class="float-right"><i class="glyph-icon icon-caret-up"></i> +5%</div></div><div class="tile-content-wrapper"><i class="glyph-icon icon-tachometer"></i><div class="tile-content"><?= $project->estimated_end_date ?></div><small><i class="glyph-icon icon-caret-up"></i> +7,6% new users in the first quarter</small></div><div class="ripple-wrapper"></div></a></div>

        <div class="col-md-4"><a href="#" title="Example box" class="tile-box btn btn-default"><div class="tile-header">Estimated Hours<div class="float-right"><i class="glyph-icon icon-caret-up"></i> +5%</div></div><div class="tile-content-wrapper"><i class="glyph-icon icon-tachometer"></i><div class="tile-content"><?= $project->estimated_time ?></div><small><i class="glyph-icon icon-caret-up"></i> +7,6% new users in the first quarter</small></div><div class="ripple-wrapper"></div></a></div>
