          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="<?= $this->Url->build(array("action" => "category", $cat->id, 'delete'));?>" onclick="return confirm('Are you sure want to delete this category?')"><i class="glyph-icon icon-trash"></i></a>
              </td>
            </tr>
            <?php }?>
          </tbody>
